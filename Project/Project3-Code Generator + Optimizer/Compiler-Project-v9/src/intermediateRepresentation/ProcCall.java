...
public class ProcCall extends Op {
	...
	public ProcCall(ProcInfo procInfo, ArrayList<Expr> actualParams) throws ErrorSemantics {
		super(procInfo.getProcId(), procInfo.getRetType());
	...
	public Type getRetType(){
		return this.procInfo.getRetType();
	}
	...
	public Expr gen() {
		...
		try {
			return new ProcCall(procInfo, reducedParams);
		} catch(Exception exc) {
